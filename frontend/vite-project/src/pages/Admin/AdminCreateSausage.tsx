...
import { useAddSausagesMutation } from '../../services/products';

type ButtonType = 'dashboard' | 'allProducts';

const AdminCreateSausage = () => {
  const navigate = useNavigate()
  const [addSausages] = useAddSausagesMutation();
  ...
  const handleAddSausageClick = async () => {
    if (!selectedImage) {
    ...
    try {
      const response = await addSausages(formData).unwrap();
            ...
            <div className={styles.addProductJerks}>
              ...
              <div className={styles.addProduct__rightContentJerks}>
                ...
                <div className={`${styles.buttons} flex`}>
                  ...
                  <button onClick={handleAddSausageClick} className={`${styles.btn} btn`}>
                    Create
                  </button>
                </div>
              </div>
...
export default AdminCreateSausage
