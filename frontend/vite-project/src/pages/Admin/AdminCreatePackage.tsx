...
import { useAddPackingMutation } from '../../services/products';
...
const AdminCreatePackage = () => {
  ...
  const handleAddPackingClick = async () => {
    if (!selectedImage) {
    ...
    try {
      const response = await addPacking(formData).unwrap(); 
            ...
            <div className={styles.addProductJerks}>
              ...
              <div className={styles.addProduct__rightContentJerks}>
                ...
                <div className={`${styles.buttons} flex`}>
                  ...
                  <button onClick={handleAddPackingClick} className={`${styles.btn} btn`}>
                    Create
                  </button>
                </div>
              </div>
