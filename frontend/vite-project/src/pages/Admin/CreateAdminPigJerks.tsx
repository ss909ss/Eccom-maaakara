...
import {  useAddPigJerksMutation } from '../../services/products';

type ButtonType = 'dashboard' | 'allProducts';

const CreateAdminPigJerks = () => {
  ...
  const [addPigJerks] = useAddPigJerksMutation();
  ...
  const handleAddPigJerksClick = async () => {
    if (!selectedImage) {
    ...
    try {
      const response = await addPigJerks(formData).unwrap(); 
            ...
            <div className={styles.addProductJerks}>
              ...
              <div className={styles.addProduct__rightContentJerks}>
                ...
                <div className={`${styles.buttons} flex`}>
                  ...
                  <button onClick={handleAddPigJerksClick} className={`${styles.btn} btn`}>
                    Create
                  </button>
                </div>
              </div>
...
export default CreateAdminPigJerks
